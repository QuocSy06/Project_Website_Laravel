            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-4">
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">                                
                            <div class="text-center w-75 m-auto">
                                ...
                                <p class="text-muted mb-4 mt-3">Nhập địa chỉ email và mật khẩu của bạn.</p>
                            </div>
                            @include('admin.alert')
                            <form action="{{ route('login') }}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="email" type="email" id="emailaddress"  value="{{old ('email')}}" placeholder="Nhập địa chỉ email">
                                </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-6 text-center">
                            <p> <a href="{{  route('register')  }}" class="text-white-50 ms-1">Bạn chưa có tài khoản?</a></p>
                        </div> 
                    </div>
                    <!-- end row -->
