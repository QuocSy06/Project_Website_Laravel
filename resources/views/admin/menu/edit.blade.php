                        ...
                        <div class="col-lg-6">
                            <form action="" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="description" rows="5">{{ $menu->description }}</textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Cập nhật danh
                                        mục</button>
                                </div>
                                @csrf
                        </div> <!-- end col -->
